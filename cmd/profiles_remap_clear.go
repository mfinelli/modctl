...
var (
	profilesRemapClearGame    string
	profilesRemapClearProfile string
)

var profilesRemapClearCmd = &cobra.Command{
	Use:   "clear",
	Short: "Remove all remap rules for a mod version in a profile",
	Long: `Remove all remap rules for a mod version in a profile.
...
func init() {
	profilesRemapCmd.AddCommand(profilesRemapClearCmd)

	profilesRemapClearCmd.PersistentFlags().StringVarP(&profilesRemapClearGame, "game", "g", "",
		"Override the currently active game")
	profilesRemapClearCmd.RegisterFlagCompletionFunc("game",
		func(cmd *cobra.Command, args []string, toComplete string) ([]string, cobra.ShellCompDirective) {
			return completion.GameInstallSelectors(cmd, toComplete)
		})
	profilesRemapClearCmd.PersistentFlags().StringVarP(&profilesRemapClearProfile, "profile", "p", "",
		"Override the currently active profile")
	profilesRemapClearCmd.RegisterFlagCompletionFunc("profile",
		func(cmd *cobra.Command, args []string, toComplete string) ([]string, cobra.ShellCompDirective) {
